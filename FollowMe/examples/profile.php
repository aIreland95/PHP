                      ...
                      while($row2 = $result->fetch_assoc()) {
                        ...
                        if (in_array($user_id, $following_user_ids)) {
                          echo "<li>";
              						echo	"<div class=\"row\">";
              						echo		"<div class=\"col-md-2 col-sm-2 ml-auto mr-0\">";
              						echo			"<img src=" . $row2['image_url'] . " alt=\"Circle Image\" class=\"img-circle img-no-padding img-responsive\">";
              						echo		"</div>";
              						echo		"<div class=\"col-md-7 col-sm-4  ml-0 mr-0\">";
              						echo			"<h6>" . $row2['first_name'] . " " . $row2['last_name'] . "<br/><small>" . $row2['title'] . "</small></h6>";
              						echo		"</div>";
              						echo	"</div>";
              						echo "</li>";
                          echo "<hr />";
